...
project_root = os.path.abspath(os.path.join(script_dir, ".."))  # 상위 디렉토리로 이동

# 사용자가 선택할 수 있는 폴더 목록
input_folders = {
    '1': 'datasets_origin/',
    '2': 'datasets_del_aug_duplicate/',
    '3': '_preprocessed_datasets_2/',
    '4': '_preprocessed_datasets_3/',
    '5': '_preprocessed_datasets_4/'
}
...
# 출력 폴더의 절대 경로 설정
output_folder = os.path.join(project_root, f"_preprocessed_{os.path.basename(input_folders[user_choice].strip('/'))}")
